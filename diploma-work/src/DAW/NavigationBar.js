      ...
      <Navbar.Collapse id="basic-navbar-nav ms-0">
        <Nav className="mr-auto collapse navbar-collapse">
          ...
          <div className='d-flex'>
            ...
            <span className='text-white mx-1 '><i class="bi bi-play-fill"></i></span >
            <span  className='text-white mx-1 '><i class="bi bi-stop-fill"></i></span>
            <span  className='text-white mx-1 '><i class="bi  bi-arrow-repeat"></i></span >
            </div>
